...
export const POSTS_UPLOAD_REQUEST = 'POSTS_UPLOAD_REQUEST';
export const POSTS_UPLOAD_SUCCESS = 'POSTS_UPLOAD_SUCCESS';
export const POSTS_UPLOAD_FAILURE = 'POSTS_UPLOAD_FAILURE';